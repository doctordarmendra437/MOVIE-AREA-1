...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5234918257').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002804180914').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002984344864'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1003016941305'))  # Bin channel id (make sure bot is admin)
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1003016941305'))  # Premium logs channel id
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002918425042')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002918425042')  # Request channel id (make sure bot is admin)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/moviesupportchats437')  # Support group link (make sure bot is admin)

# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1002952905775")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
auth_channels     = environ.get("AUTH_CHANNELS", "-1002896274382")# Channels for force sub (make sure bot is admin)

# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', '')    # QR code image for payments
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'ritesh2010@fam')    # Owner UPI ID for payments
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://riteshkumarsingh:iX9Eeca9iRTH3buu@cluster0.sqrcqji.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")  # MongoDB URI for the database
DATABASE_NAME = environ.get('DATABASE_NAME', "riteshkumarsingh") # Database name (default: cluster)
...
MULTIPLE_DB = is_enabled(os.environ.get('MULTIPLE_DB', "riteshkumarsingh 9594"), True) # Type True For Turn On MULTIPLE DB FUNTION 
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://riteshkumarsingh9594:riteshkumarsingh9594@cluster0.sqrcqji.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")  # MongoDB URI for the second database (if MULTIPLE_DB is True)
# ============================
# Movie Notification & Update Settings
# ============================
MOVIE_UPDATE_NOTIFICATION = bool(environ.get('MOVIE_UPDATE_NOTIFICATION', True))  # Notification On (True) / Off (False)
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002952905775'))  # Notification of sent to your channel
...
TMDB_API_KEY = environ.get('TMDB_API_KEY', 'ef3c1b0cd5da188eabeb78d8f673ca45') # preffer to use your own tmdb API Key get it from https://www.themoviedb.org/settings/api
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002860590556')) #Verification Channel Id 
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1003014667487')) #If Anyone Set Your Bot In Any Group And Set Shortner In That Group Then In This Channel The All Details Come
VERIFY_IMG = environ.get("VERIFY_IMG", "https://telegra.ph/file/9ecc5d6e4df5b83424896.jpg")

TUTORIAL = environ.get("TUTORIAL", "https://t.me/ninjamodz437/121")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/ninjamodz437/121")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/ninjamodz437/121")   # Third tutorial link for verification

# Verification (Must Fill All Veriables. Else You Got Error
SHORTENER_API = environ.get("SHORTENER_API", "ef9e633750559cdcc7b4dc6e544b53370a5116f0") # Shortener API key
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "earnlinks.in") # Shortener website

SHORTENER_API2 = environ.get("SHORTENER_API2", "ef9e633750559cdcc7b4dc6e544b53370a5116f0")  # Shortener API key for second website
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "earnlinks.in") # Shortener website for second website
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/moviearea_437') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/riteshkumarsingh437') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/moviearea437') # Update channel link for the bot
