...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://Mongodb:Mongodb@cluster0.mduexta.mongodb.net/?appName=Cluster0")  # MongoDB URI for the second database (if MULTIPLE_DB is True)
# ============================
